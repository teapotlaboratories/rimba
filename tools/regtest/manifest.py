...
APPS: tuple[App, ...] = (
    ...
    App("test-ibss-boottime",
        notes="RISK-02 cold-boot -> IBSS-joined -> first-frame timing fixture. ONE binary, role by a "
              "build flag: IBSS_CREATE=1 -> the always-on creator/peer (board0, static IP, lwIP auto-replies); "
              "default -> the MEASURE DUT (board2) which JOINs, pings PING_IP=, and prints one "
