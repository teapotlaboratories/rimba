...
- **Review before merge** — run `/review <PR #>` against the PR before merging
  it, and fix (or file as a tracked TODO) every real finding; never merge with
  open correctness findings. That is the only review required. See
