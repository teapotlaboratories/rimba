...
> **Bring-up runbook:** [`reference/rimba-linux-node-setup.md`](../reference/rimba-linux-node-setup.md) §12 (IBSS interop)
...
see [`reference/rimba-linux-node-setup.md`](../reference/rimba-linux-node-setup.md)). Linux joined via
