...
- ☐ **802.11s mesh port — P0 firmware feasibility probe** (next active step) → [`mesh-ap/rimba-mesh-ap-milestones.md`](mesh-ap/rimba-mesh-ap-milestones.md) (802.11s item) + recon [`worklog/2026-06-24-mesh-80211s-port-recon.md`](worklog/2026-06-24-mesh-80211s-port-recon.md). Confirm the ESP32 fw accepts `ADD_INTERFACE(type=5)` + `MESH_CONFIG`; gates the multi-PR P1–P5 port.
