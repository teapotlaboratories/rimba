# c6-harness — ESP32-C6 companion for the board2 PS-measurement rig

An **ESP32-C6-DevKitC-1** drives board2's **D5** (XIAO ESP32-S3 GPIO6) over a single wire from **C6 GPIO20**
(+ common GND) to trigger board2's PS ladder and to drive its flash-hold guard. board2 is powered and
